...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-8">
        <div class="container">
            <span class="row flex-center">User Login Form</span>
            <center>
                            <p>
                            <form action="./UserLoginCheck" method="POST" class="table-responsive" style="width:100%">
                                <table>
                                ...
                                if (msg != null && msg.equalsIgnoreCase("success")) {
                                    ...
                                    out.println("<font color='PINK'>Your account not activated</font>");
                                }else if (msg != null && msg.equalsIgnoreCase("failed")) {
                                    out.println("<font color='PINK'>Account Doesnot Exist</font>");
                                }
