        ...
        <div class="container">
          <div class="row align-items-center min-vh-75 min-vh-md-100">
            <div class="col-md-7 col-lg-6 py-6 text-sm-start text-center">
              <h1 class="mb-4 display-2 fw-semi-bold lh-sm">Blockchain as a Platform for  <br class="d-block d-lg-none d-xl-block" />Secure Cloud Computing Services</h1>
              <p class="mb-4 fs-1">The blockchain was conceptualized and developed by Satoshi Nakamoto</p>
              <div class="pt-3">
               <!-- <form>
