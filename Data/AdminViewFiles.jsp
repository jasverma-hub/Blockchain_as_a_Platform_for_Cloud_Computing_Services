...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-8">
        <div class="container">
            <h2><abbr>View ALl Files</abbr></h2>
                                ...
                                <tbody>
                                    ...
                                    try(Connection con = DBConnection.getDBConnection()){
                                     ...
                                     <tr scope="row" style="color: BLUE; background-color:#FFFCBB">
                                        ...
                                        <td><a class="btn-link" href="./AdminDeleteFile.jsp?id=<%=id%>" style="color:DARKBLUE">Delete</a></td>
                                        <!--<td><a class="btn-link" href="./AdminDownloadCode?id=<%=id%>" style="color:DARKBLUE">Download</a></td>-->
                                        <td><a class="btn-link" href="./UserFileDownload.jsp?id=<%=id%>" target="_blank" style="color:DARKBLUE">Download</a></td>
